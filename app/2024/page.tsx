  ...
  return (
    <>
      ...
      <Wrapper>
        ...
        <CalendarDoor link="2024/day-03" isStarted={true} status="silver">
          3
        </CalendarDoor>
        <CalendarDoor link="2024/day-04" isStarted={false} status="n/a">
          4
        </CalendarDoor>
        <CalendarDoor link="2024/day-05" isStarted={false} status="n/a">
          5
        </CalendarDoor>
