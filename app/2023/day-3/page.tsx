      ...
      indicesArray.forEach((index) => {
        ...
        for (let a = 0; a < indexArray.length; a++) {
          ...
          if (!isNaN(+value)) {
            ...
            for (
              let i = indexArray[a] - 1;
              i >= 0 && /\d/.test(formattedData[i]);
              i--
            ) {
            ...
            for (
              let i = indexArray[a] + 1;
              i < formattedData.length && /\d/.test(formattedData[i]);
              i++
            ) {
            ...
            const arrayAlreadyExists = doesIndexAlreadyExist(
              numberIndices.sort(),
              allNumberIndices
            );
