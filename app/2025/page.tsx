  ...
  return (
    <>
      ...
      <Wrapper>
        ...
        <CalendarDoor link="2025/day-02" isStarted={true} status="gold">
          2
        </CalendarDoor>
        <CalendarDoor link="2025/day-03" isStarted={true} status="gold">
          3
        </CalendarDoor>
        <CalendarDoor link="2025/day-04" isStarted={true} status="gold">
          4
        </CalendarDoor>
        <CalendarDoor link="2025/day-05" isStarted={true} status="gold">
          5
        </CalendarDoor>
        <CalendarDoor link="2025/day-06" isStarted={true} status="silver">
          6
        </CalendarDoor>
        <CalendarDoor link="2025/day-07" isStarted={true} status="gold">
          7
        </CalendarDoor>
        <CalendarDoor link="2025/day-08" isStarted={true} status="n/a">
          8
        </CalendarDoor>
