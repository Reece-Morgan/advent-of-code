...
import { daySixData } from "puzzle-inputs/2023/6";
...
const TwentyTwentyThree_DaySix = () => {
    ...
    const partTwo = (data: string) => {
        ...
        const totalTime = parseInt(arrOfTime.reduce((acc, current) => acc + current));
        const totalDistance = parseInt(arrOfDistance.reduce((acc, current) => acc + current));
